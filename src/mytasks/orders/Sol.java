...
public class Sol {
//    задача пройтись по всему массиву последовательно посмотреть работает или нет.
//    добавить ограничение по радиусу, вкотором может бегать данная окгружность
...
//        long startTime = System.currentTimeMillis();
        ...
        for (int r = 1; r <= N; r++) {
            for (int c = 1; c <= M; c++) {
                max = Math.max(max, omNomNom(R, r, c));
            }
        }
...
//        System.out.println("время выполнения:" + time);
    ...
    static int omNomNom(int R, int r, int c){
