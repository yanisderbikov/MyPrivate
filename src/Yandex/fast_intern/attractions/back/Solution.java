package Yandex.fast_intern.attractions.back;
...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        list.sort(new Comparator<int[]>() { // cкорее всего должно производиться без ссортировки
            @Override                       // Нужно попробовать использовать вместо ArrayList HashMap
